  ...
  return (
    <div className="w-full">
      <Helmet>
        <meta charSet="utf-8" />
        <title>
          Services - Hiqsense Smart Systems: Enhancing Your Business Through
          Technology
        </title>
        <meta
          name="description"
          content="Explore the wide range of services offered by Hiqsense Smart Systems,
        ...
        />
        <link rel="canonical" href="https://hiqsense.ca/services" />
      </Helmet>
      <Hero />
